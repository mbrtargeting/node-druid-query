 ...
 * @param {object} httpOptions optional set of options to pass to the request
 */
Client.prototype.exec = function (query, callback, httpOptions) {
...
/**
 * Execute query, returning an http.IncomingMessage that can be streamed
 * 
 * Note that the response will be gzipped and you must handle this.
 *
 * @public
 * @param {Query} query Query object
 * @param {function} callback Accepts arguments: (err, data: http.IncomingMessage)
 * @param {object} httpOptions optional set of options to pass to the request
 */
Client.prototype.execStreaming = function (query, callback, httpOptions) {
